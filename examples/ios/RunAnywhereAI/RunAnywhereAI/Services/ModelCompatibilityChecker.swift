...
struct ModelCompatibilityView: View {
    ...
    @State private var result: ModelCompatibilityChecker.CompatibilityResult?
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: 20) {
                ...
                VStack(alignment: .leading, spacing: 8) {
                    ...
                    HStack {
                        Label(framework.displayName, systemImage: "cpu")
                        Spacer()
        ...
        .navigationTitle("Compatibility Check")
        .navigationBarTitleDisplayMode(.inline)
        .task {
            result = ModelCompatibilityChecker.checkCompatibility(model: model, framework: framework)
        }
    }
}
